    ...
    public static class ShellSummarySnapshotMapper
    {
        ...
        private static ShellSummarySnapshot Map(JObject summary)
        {
            ...
            var buildingObjects = ObjectsFromArrays(
                ...
                summary["activeBuild"],
                summary["active_build"],
                summary["activeBuildProject"],
                summary["active_build_project"],
                summary["activeConstruction"],
                summary["active_construction"],
                summary["activeUpgrade"],
                summary["active_upgrade"],
                ...
                city?["activeBuild"],
                city?["active_build"],
                city?["activeBuildProject"],
                city?["active_build_project"],
                city?["activeConstruction"],
                city?["active_construction"],
                city?["activeUpgrade"],
                city?["active_upgrade"],
