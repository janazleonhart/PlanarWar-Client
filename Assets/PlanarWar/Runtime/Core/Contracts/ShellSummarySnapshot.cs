...
namespace PlanarWar.Client.Core.Contracts
{
    ...
    [Serializable] public sealed class OperationSnapshot { public string Title { get; set; } = "Operation"; public string Readiness { get; set; } = "-"; public string Kind { get; set; } = string.Empty; public string Role { get; set; } = string.Empty; public string ArmyId { get; set; } = string.Empty; public string HeroId { get; set; } = string.Empty; public string MissionId { get; set; } = string.Empty; public string ActionId { get; set; } = string.Empty; public string ResponsePosture { get; set; } = string.Empty; }
    [Serializable] public sealed class MissionSnapshot { public string Id { get; set; } = "mission"; public string Title { get; set; } = "Mission"; public string InstanceId { get; set; } = string.Empty; public DateTime? FinishesAtUtc { get; set; } }
    [Serializable] public sealed class HeroSnapshot { public string Id { get; set; } = string.Empty; public string Name { get; set; } = "Hero"; public string Role { get; set; } = string.Empty; public string Status { get; set; } = "-"; public double? Level { get; set; } public int AttachmentCount { get; set; } public List<string> ResponseRoles { get; set; } = new(); }
    [Serializable] public sealed class ArmySnapshot { public string Id { get; set; } = string.Empty; public string Name { get; set; } = "Army"; public string Type { get; set; } = string.Empty; public string Status { get; set; } = "-"; public double? Readiness { get; set; } public double? Power { get; set; } public double? Size { get; set; } public string HoldRegionId { get; set; } = string.Empty; public string HoldPosture { get; set; } = string.Empty; public List<string> Specialties { get; set; } = new(); }
