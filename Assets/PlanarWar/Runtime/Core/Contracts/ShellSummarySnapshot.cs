...
namespace PlanarWar.Client.Core.Contracts
{
    ...
    public sealed class ShellSummarySnapshot
    {
        ...
        public List<MissionOfferSnapshot> MissionOffers { get; set; } = new();
        ...
        public HeroArmoryBridgeSnapshot HeroArmoryBridge { get; set; }
    ...
    [Serializable]
    public sealed class EarlyLanePostureSnapshot
    {
    ...
    public sealed class MotherBrainPressureReceiptFollowThroughSnapshot
    {
        ...
        public List<MotherBrainPressureResponseHistoryEntrySnapshot> ResponseHistory { get; set; } = new();
        public MotherBrainPressureBlockerRecoverySnapshot BlockerRecovery { get; set; }
    }

    [Serializable]
    public sealed class MotherBrainPressureResponseHistoryEntrySnapshot
    {
        ...
        public string Severity { get; set; } = string.Empty;
        public string ReceiptState { get; set; } = string.Empty;
        public string RuntimeActionId { get; set; } = string.Empty;
        public string SourceRegionId { get; set; } = string.Empty;
        public string ThreatFamily { get; set; } = string.Empty;
    ...
    [Serializable] public sealed class ResearchSnapshot { public string Id { get; set; } public string Name { get; set; } public string Status { get; set; } = string.Empty; public double? Progress { get; set; } public double? Cost { get; set; } public DateTime? StartedAtUtc { get; set; } public DateTime? FinishesAtUtc { get; set; } }
    [Serializable] public sealed class BuildingSnapshot { public string Id { get; set; } = string.Empty; public string BuildingId { get; set; } = string.Empty; public string Type { get; set; } = string.Empty; public string Name { get; set; } = "Building"; public string Lane { get; set; } = string.Empty; public string Status { get; set; } = string.Empty; public string RoutingPreference { get; set; } = string.Empty; public int? Level { get; set; } public int? Slot { get; set; } public DateTime? StartedAtUtc { get; set; } public DateTime? FinishesAtUtc { get; set; } public string Detail { get; set; } = string.Empty; public string EffectSummary { get; set; } = string.Empty; public ResourceSnapshot ProductionPerTick { get; set; } = new(); }
    ...
    [Serializable] public sealed class MissionSnapshot { public string Id { get; set; } = "mission"; public string Title { get; set; } = "Mission"; public string InstanceId { get; set; } = string.Empty; public string RegionId { get; set; } = string.Empty; public string AssignedArmyId { get; set; } = string.Empty; public string AssignedArmyName { get; set; } = string.Empty; public string AssignedHeroId { get; set; } = string.Empty; public string AssignedHeroName { get; set; } = string.Empty; public string ResponsePosture { get; set; } = string.Empty; public string BoardState { get; set; } = string.Empty; public string BoardCategory { get; set; } = string.Empty; public string Summary { get; set; } = string.Empty; public string Payoff { get; set; } = string.Empty; public string Risk { get; set; } = string.Empty; public DateTime? FinishesAtUtc { get; set; } }
    [Serializable] public sealed class MissionOfferSnapshot { public string Id { get; set; } = "mission"; public string Title { get; set; } = "Mission"; public string Kind { get; set; } = string.Empty; public string RegionId { get; set; } = string.Empty; public string BoardState { get; set; } = string.Empty; public string BoardCategory { get; set; } = string.Empty; public string BoardSourceKind { get; set; } = string.Empty; public string BoardLaneTone { get; set; } = string.Empty; public string Difficulty { get; set; } = string.Empty; public string Summary { get; set; } = string.Empty; public string Payoff { get; set; } = string.Empty; public string Risk { get; set; } = string.Empty; public List<string> ResponseTags { get; set; } = new(); }
    ...
    [Serializable]
    public sealed class HeroArmoryBridgeSnapshot
    {
        public HeroArmorySummarySnapshot Summary { get; set; } = new();
        public List<HeroArmoryItemSnapshot> ArmoryItems { get; set; } = new();
        public List<HeroEquipmentSnapshot> HeroEquipment { get; set; } = new();
        public string Note { get; set; } = string.Empty;
    }

    [Serializable] public sealed class HeroArmorySummarySnapshot { public string OwnerId { get; set; } = string.Empty; public int? SlotCount { get; set; } public int? OccupiedSlots { get; set; } public int? DistinctItemIds { get; set; } public int? TotalItemCount { get; set; } }
    [Serializable] public sealed class HeroEquipmentTemplateSnapshot { public string Id { get; set; } = string.Empty; public string Name { get; set; } = string.Empty; public string Slot { get; set; } = string.Empty; public string Rarity { get; set; } = string.Empty; public string Category { get; set; } = string.Empty; public string Description { get; set; } = string.Empty; public List<string> Tags { get; set; } = new(); public Dictionary<string, double> Stats { get; set; } = new(); }
    [Serializable] public sealed class HeroGearFitSnapshot { public string HeroId { get; set; } = string.Empty; public string HeroName { get; set; } = string.Empty; public string Role { get; set; } = string.Empty; public double? Score { get; set; } public string Summary { get; set; } = string.Empty; }
    [Serializable] public sealed class HeroEquipmentEntrySnapshot { public string Slot { get; set; } = string.Empty; public string ItemId { get; set; } = string.Empty; public int? Qty { get; set; } public string GenesisId { get; set; } = string.Empty; public HeroEquipmentTemplateSnapshot Template { get; set; } public HeroGearFitSnapshot EquippedHeroFit { get; set; } }
    [Serializable] public sealed class HeroArmoryItemSnapshot { public int? SlotIndex { get; set; } public string ItemId { get; set; } = string.Empty; public int? Qty { get; set; } public string GenesisId { get; set; } = string.Empty; public HeroEquipmentTemplateSnapshot Template { get; set; } public List<HeroGearFitSnapshot> TopHeroFits { get; set; } = new(); }
    [Serializable] public sealed class HeroArmoryRecommendationSnapshot { public int? SlotIndex { get; set; } public string ItemId { get; set; } = string.Empty; public int? Qty { get; set; } public string GenesisId { get; set; } = string.Empty; public HeroEquipmentTemplateSnapshot Template { get; set; } public HeroGearFitSnapshot Fit { get; set; } public string TargetSlot { get; set; } = string.Empty; public string State { get; set; } = string.Empty; public double? DeltaScore { get; set; } public string Summary { get; set; } = string.Empty; }
    [Serializable] public sealed class HeroEquipmentSnapshot { public string HeroId { get; set; } = string.Empty; public List<HeroEquipmentEntrySnapshot> Equipment { get; set; } = new(); public List<string> EmptySlots { get; set; } = new(); public string EmptySlotSummary { get; set; } = string.Empty; public List<HeroArmoryRecommendationSnapshot> RecommendedArmory { get; set; } = new(); public List<HeroArmoryRecommendationSnapshot> BestLoadoutPlan { get; set; } = new(); public string BestLoadoutSummaryNote { get; set; } = string.Empty; public List<string> LoadoutResetSlots { get; set; } = new(); public string LoadoutResetSummaryNote { get; set; } = string.Empty; }
    ...
    [Serializable] public sealed class WorkshopRecipeSnapshot { public string RecipeId { get; set; } = "recipe"; public string Name { get; set; } = "Recipe"; public string Summary { get; set; } = string.Empty; public string GearFamily { get; set; } = string.Empty; public string GearSlot { get; set; } = string.Empty; public string OutputItemId { get; set; } = string.Empty; public double? WealthCost { get; set; } public double? ManaCost { get; set; } public double? MaterialsCost { get; set; } public double? CraftMinutes { get; set; } public List<string> ResponseTags { get; set; } = new(); }
