...
namespace PlanarWar.Client.Core.Contracts
{
    ...
    [Serializable] public sealed class OperationSnapshot { public string Id { get; set; } = "operation"; public string Title { get; set; } = "Operation"; public string Summary { get; set; } = string.Empty; public string Detail { get; set; } = string.Empty; public string WhyNow { get; set; } = string.Empty; public string Payoff { get; set; } = string.Empty; public string Risk { get; set; } = string.Empty; public string Lane { get; set; } = string.Empty; public string Priority { get; set; } = string.Empty; public string Readiness { get; set; } = "-"; public string CtaLabel { get; set; } = string.Empty; public string FocusLabel { get; set; } = string.Empty; public List<string> ImpactPreview { get; set; } = new(); public OpeningActionSnapshot Action { get; set; } = new(); }
    [Serializable] public sealed class OpeningActionSnapshot { public string Kind { get; set; } = string.Empty; public string BuildingKind { get; set; } = string.Empty; public string BuildingId { get; set; } = string.Empty; public string TechId { get; set; } = string.Empty; public string MissionId { get; set; } = string.Empty; public string ActionId { get; set; } = string.Empty; public string Role { get; set; } = string.Empty; public string ArmyId { get; set; } = string.Empty; public string HeroId { get; set; } = string.Empty; public string ResponsePosture { get; set; } = string.Empty; }
    [Serializable] public sealed class MissionSnapshot { public string Id { get; set; } = "mission"; public string InstanceId { get; set; } = string.Empty; public string Title { get; set; } = "Mission"; public DateTime? FinishesAtUtc { get; set; } }
