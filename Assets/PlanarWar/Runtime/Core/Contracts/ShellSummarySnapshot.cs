...
namespace PlanarWar.Client.Core.Contracts
{
    ...
    [Serializable] public sealed class BuildingSnapshot { public string Id { get; set; } = string.Empty; public string BuildingId { get; set; } = string.Empty; public string Type { get; set; } = string.Empty; public string Name { get; set; } = "Building"; public string Lane { get; set; } = string.Empty; public string Status { get; set; } = string.Empty; public int? Level { get; set; } public int? Slot { get; set; } public DateTime? StartedAtUtc { get; set; } public DateTime? FinishesAtUtc { get; set; } public string Detail { get; set; } = string.Empty; public string EffectSummary { get; set; } = string.Empty; public ResourceSnapshot ProductionPerTick { get; set; } = new(); }
