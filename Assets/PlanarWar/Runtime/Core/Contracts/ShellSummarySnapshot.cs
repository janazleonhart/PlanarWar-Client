...
namespace PlanarWar.Client.Core.Contracts
{
    ...
    [Serializable] public sealed class WorkshopJobSnapshot { public string Id { get; set; } = "job"; public string RecipeId { get; set; } = string.Empty; public string AttachmentKind { get; set; } = string.Empty; public string OutputName { get; set; } = string.Empty; public string OutputItemId { get; set; } = string.Empty; public string DisplayName { get; set; } = "Workshop job"; public bool Completed { get; set; } public DateTime? FinishesAtUtc { get; set; } }
