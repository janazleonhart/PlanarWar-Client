...
namespace PlanarWar.Client.Core.Contracts
{
    ...
    [Serializable] public sealed class ArmySnapshot { public string Id { get; set; } = string.Empty; public string Name { get; set; } = "Army"; public string Status { get; set; } = "-"; public double? Readiness { get; set; } }
    ...
    [Serializable] public sealed class HeroRecruitCandidateSnapshot { public string CandidateId { get; set; } = string.Empty; public string Lane { get; set; } = string.Empty; public string Role { get; set; } = string.Empty; public string ClassId { get; set; } = string.Empty; public string ClassName { get; set; } = string.Empty; public string DisplayName { get; set; } = string.Empty; public string Summary { get; set; } = string.Empty; public List<string> Traits { get; set; } = new(); public double? WealthCost { get; set; } public double? UnityCost { get; set; } }
